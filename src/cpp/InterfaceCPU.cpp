...
MOCKSZ_DLL void MockSZ_getSignal_ntSZ(double *nu, int n_nu, double alpha, double *output, int n_s, int n_beta, bool no_CMB) {
    calcSignal_ntSZ(nu, n_nu, alpha, output, n_s, n_beta, no_CMB);
}
